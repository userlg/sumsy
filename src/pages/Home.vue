...
const showContent = ref(false); // Controla la animación de entrada
...
<template>
  <transition name="bounce">
    <div
      v-if="showContent"
      class="relative flex flex-col items-center justify-center text-center p-4 h-full"
    >
      <!-- Logo -->
      <Logo
        id="Logo"
      ...
      >
        Bienvenido, <span class="font-semibold">{{ userStore.getName }}</span
        >!
      </h2>
